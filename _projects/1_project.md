...
__Site Analysis__: Conducted a comprehensive analysis of the target site, examining current land use, pedestrian traffic flow, accessibility, and environmental conditions to identify key constraints and opportunities.

__Case Studies & Benchmarking__: Researched best practices from other university campuses and urban revitalization projects worldwide to gather innovative ideas and establish benchmarks for success.

__Concept Development__: Brainstormed and developed three distinct activation concepts: (A) a student-led startup incubator, (B) a multi-purpose cultural complex, and (C) an eco-friendly community park. Each concept was evaluated based on feasibility, potential impact, and sustainability.
